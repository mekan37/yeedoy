...
**Kaynak kararları:** `docs/urun/2026-yeedoy-final-scope-source-of-truth.md`
...
**Final scope'ta mutlaka tanımlanmalıdır:** Eğer 5 sayfanın tamamı REDIRECT_NOW olursa, `docs/urun/2026-yeedoy-final-scope-source-of-truth.md` bu kararı yansıtsın.
