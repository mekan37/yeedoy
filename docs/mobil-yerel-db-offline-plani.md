...
Tarih: 2026-03-07  
Kapsam: `uygulamalar/mobil` local DB tabanli offline mode degerlendirmesi
...
- buyuk read payload'larda cache invalidation/kesify kisitli
...
- bu adimla read snapshot persistence ve replay tetikleme sertlesti; menu price suggestion/menu item suggestion sonrasi favorite, price vote, follow ve photo vote da explicit server-side idempotency'ye alindi, conflict policy devtools/runbook diline ve owner/admin observability yuzeyine tasindi
...
- model: `uygulamalar/mobil/lib/core/storage/yerel_db/yerel_db_modelleri.dart`
- abstraction: `uygulamalar/mobil/lib/core/storage/yerel_db/yerel_db_deposu.dart`
- memory adapter: `uygulamalar/mobil/lib/core/storage/yerel_db/bellek_yerel_db_deposu.dart`
- disk-backed gecis adapter'i: `uygulamalar/mobil/lib/core/storage/yerel_db/paylasilan_tercihler_yerel_db_deposu.dart`
- sqlite adapter'i: `uygulamalar/mobil/lib/core/storage/yerel_db/sqflite_yerel_db_deposu.dart`
- provider baglantisi: `uygulamalar/mobil/lib/core/storage/yerel_db/yerel_db_saglayicisi.dart`
- connectivity replay servisi: `uygulamalar/mobil/lib/core/network/connectivity_restore_service.dart`
- test: `uygulamalar/mobil/test/core/storage/yerel_db/bellek_yerel_db_deposu_test.dart`
