...
| Belge | Icerik |
|---|---|
| `docs/yayin/mobile-release-readiness.md` | Tam release checklist + §16 Store Asset Üretimi (screenshot specs, release notes sablonu, feature graphic) |
| `docs/yayin/store_listing.md` | ASO copy (TR + EN), anahtar kelimeler |
| `docs/yayin/store-data-safety-iarc.md` | Data Safety + IARC taslak |
