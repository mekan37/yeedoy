...
### 5. KDS / mutfak ekranı
Keywords: `kds, kitchen_display, mutfak`. No KDS surface anywhere. `docs/product/2026-yeedoy-final-scope-source-of-truth.md:18` explicitly marks out-of-scope. **CLEAN / COMMENT_ONLY**.
...
| `docs/product/2026-yeedoy-final-scope-source-of-truth.md:22` | **DOCUMENTED** | explicitly marks badge/quest/XP/level/check-in/achievement out-of-scope. |
...
- `docs/product/2026-yeedoy-final-scope-source-of-truth.md` — correctly enumerates all 12 topics as out-of-scope (lines 12-22).
