...
**Kaynak karar planı:** `docs/legal/r5-unsubscribe-web-edge-decision-plan.md`  
...
Bu senaryolar `test:e2e` playwright testleri veya Supabase local stack ile çalıştırılabilir. Bunlar için test şablonları `docs/legal/` klasörüne ayrı bir dosyada hazırlanabilir.
