...
**Karar referansı:** `docs/legal/r4-ip-metadata-decision-plan.md` — Seçenek B  
...
*Bu rapor `docs/legal/r4-ip-metadata-decision-plan.md` ve `docs/legal/critical-privacy-gaps-report.md` ile birlikte okunmalıdır. Migration production'a uygulanmadan önce hukuk danışmanı onayı alınmalıdır.*
