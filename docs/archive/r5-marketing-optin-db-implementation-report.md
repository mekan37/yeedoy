...
**Önceki rapor:** `docs/legal/r5-marketing-optin-data-model-decision.md`  
...
`docs/legal/r5-marketing-optin-data-model-decision.md` raporunda `user_profiles` olarak doğru belirtilmiş. Farklılık yok.
