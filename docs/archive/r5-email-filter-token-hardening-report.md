...
**Tarih:** 2026-06-18  
**Önceki rapor:** `docs/legal/r5-unsubscribe-security-verification-report.md`  
...
|---------------|-------|---------------|
| `docs/legal/*.md` | Çeşitli eski raporlar | Tarihsel referans — kaynak kod değil, etki yok |
| `docs/legal/r5-marketing-optin-data-model-decision.md` | Eski karar belgesi | Arşiv — uygulanmış karar, değiştirilmedi |
