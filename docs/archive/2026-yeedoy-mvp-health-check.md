...
> **Kapsam kaynağı:** `docs/product/2026-yeedoy-final-scope-source-of-truth.md`.
> **Önceki audit (temizlik kapsamı):** `docs/engineering/2026-yeedoy-nonproduct-leftovers-audit.md`.
