...
- `npm --prefix apps/web_next run build` PASS mi?
- `npm --prefix apps/web_next run test:e2e:live` PASS mi?
- `npm --prefix apps/web_next run lighthouse:mobile` guncel rapor uretti mi?
