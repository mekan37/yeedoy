...
This is the master navigation file for the Yeedoy repository documentation. Use it to find the right document quickly. For Turkish-language navigation, see `docs/index.md`.
...
| What is the open backlog? | [`docs/roadmap.md`](roadmap.md) |
...
| Question | Document |
|---|---|
| Full table and RPC inventory? | [`docs/data-model.md`](data-model.md) |
| Supabase security, RLS, migration health? | [`docs/DATABASE_REVIEW.md`](DATABASE_REVIEW.md) |
| RBAC roles, permissions, team model? | [`docs/rbac.md`](rbac.md) |
| Data safety, trash, restore, versioning? | [`docs/data_safety.md`](data_safety.md) |
| Audit log and visibility surface? | [`docs/audit.md`](audit.md) |
| QR system end-to-end? | [`docs/qr-system.md`](qr-system.md) |
...
| Mobile Supabase table/RPC contracts? | [`docs/mobile_supabase_contracts.md`](mobile_supabase_contracts.md) |
| Mobile release checklist? | [`docs/mobile_release_checklist.md`](mobile_release_checklist.md) |
| Mobile CI/iOS readiness? | [`docs/mobile_ci_ios_readiness.md`](mobile_ci_ios_readiness.md) |
| Mobile test strategy? | [`docs/mobile_test_strategy.md`](mobile_test_strategy.md) |
| Mobile discovery and telemetry contract? | [`docs/mobile_discovery_telemetry_contract.md`](mobile_discovery_telemetry_contract.md) |
| Mobile offline/local DB plan? | [`docs/mobile_local_db_offline_plan.md`](mobile_local_db_offline_plan.md) |
...
| Question | Document |
|---|---|
| Environment variables and deploy model? | [`docs/deploy.md`](deploy.md) |
| Smoke tests and incident runbook? | [`docs/runbook.md`](runbook.md) |
...
| Document | Purpose |
|---|---|
| [`docs/release_index.md`](release_index.md) | Index of all historical release snapshots |
| [`docs/release/`](release/) | Individual release snapshot files |
| [`docs/rollback/`](rollback/) | Rollback procedure snapshots |
| [`docs/cleanup_log.md`](cleanup_log.md) | Record of removed or cleaned-up code/docs |
| [`docs/unused_removed.md`](unused_removed.md) | Inventory of deleted unused files |
| [`docs/drift_report.md`](drift_report.md) | Docs-vs-code drift tracking |
...
**Drift status:** No HIGH-severity docs-vs-code mismatches as of 2026-03-04. See [`docs/drift_report.md`](drift_report.md) for details.
