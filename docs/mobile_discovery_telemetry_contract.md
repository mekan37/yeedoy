...
- Telemetry API: `apps/mobile_flutter/lib/core/monitoring/app_telemetry.dart`
- Event anahtarlar: `apps/mobile_flutter/lib/core/analytics/app_events.dart`
- SLO hedefleri: `apps/mobile_flutter/lib/core/perf/perf_slo.dart`
- Discovery search akisi: `apps/mobile_flutter/lib/features/discovery/data/search_repository.dart`
- Discovery home TTI akisi: `apps/mobile_flutter/lib/features/discovery/domain/discovery_search_notifier.dart`
...
3. `docs/mobile_audit_report.md` icinde P2 telemetry maddesine not dusulur
