...
| `docs/legal/r4-ip-metadata-implementation-report.md` | IP metadata migration uygulama raporu |
| `docs/legal/r4-ip-metadata-verification-report.md` | IP metadata migration doğrulama raporu |
| `docs/legal/r5-marketing-optin-data-model-decision.md` | Pazarlama opt-in veri modeli karar raporu |
| `docs/legal/r5-marketing-optin-db-implementation-report.md` | Pazarlama opt-in veritabanı uygulama raporu |
| `docs/legal/r5-marketing-optin-db-verification-report.md` | Pazarlama opt-in veritabanı doğrulama raporu |
| `docs/legal/r5-unsubscribe-web-edge-decision-plan.md` | Unsubscribe web/edge karar planı |
| `docs/legal/r5-unsubscribe-web-edge-implementation-report.md` | Unsubscribe web/edge uygulama raporu |
| `docs/legal/r5-unsubscribe-security-verification-report.md` | Unsubscribe güvenlik doğrulama raporu |
