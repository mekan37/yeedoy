...
| `docs/legal/legal-preflight-report.md` | Hukuki ön kontrol ve placeholder listesi |
| `docs/legal/critical-privacy-gaps-report.md` | R-4 / R-5 kritik gizlilik eksikleri |
...
| `docs/legal/r5-marketing-optin-data-model-decision.md` | Pazarlama opt-in veri modeli kararı |
...
| `docs/legal/gizlilik-politikasi.md` | Gizlilik Politikası taslağı |
