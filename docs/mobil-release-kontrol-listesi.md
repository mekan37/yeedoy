...
Bu belge `uygulamalar/mobil` release oncesi kontrol listesi icin tek kaynaktir.
...
- `uygulamalar/mobil/android/key.properties.example` baz alinarak doldurma kurali dokumante mi?
- Gercek keystore/secret akisi tanimli mi?
- `flutter build apk --release -t lib/mobil_giris.dart` temiz calisiyor mu?

Kritik not:

- `uygulamalar/mobil/android/uygulama/build.gradle.kts` artik debug signing'e dusmez.
...
- 2026-03-05 dogrulamasi: `flutter build apk --release -t lib/mobil_giris.dart` komutu secret eksiginde beklenen sekilde fail etti ve zorunlu env adlarini acikca yazdi.
...
- iOS release hazirligi icin tek referans belge `docs/mobil-ci-ios-hazirlik.md` dosyasidir.
...
- Android native intent seviyesinde manuel payload kontrolu icin `uygulamalar/mobil/tool/android_debug_push.ps1` kullanilabilir.
- Ornek:
  - `flutter run -d ce11160bb9d5ca2e01 -t lib/mobil_giris.dart`
  - `pwsh -File uygulamalar/mobil/tool/android_debug_push.ps1 -DeviceId ce11160bb9d5ca2e01 -Sample price-change`
...
- `uygulamalar/mobil/lib/uygulama_girisi.dart`
- `uygulamalar/mobil/lib/core/analytics/analytics_deposu.dart`
- `uygulamalar/mobil/lib/features/notifications/domain/push_notification_service.dart`

## 5. Backend Kontrat Kontrolu

- Kritik RPC'ler canli schema ile uyumlu mu?
- `docs/mobil-supabase-kontratlari.md` guncel mi?
...
- `uygulamalar/mobil/lib/core/storage/offline_cache_prefs.dart`
- `uygulamalar/mobil/lib/core/storage/yerel_db/yerel_db_saglayicisi.dart`
- `uygulamalar/mobil/lib/core/storage/yerel_db/sqflite_yerel_db_deposu.dart`
- `uygulamalar/mobil/lib/core/storage/offline_mutation_queue.dart`
- `uygulamalar/mobil/lib/features/menus/data/offline_verify_queue.dart`
- `uygulamalar/mobil/lib/core/storage/offline_submission_queue.dart`
- `uygulamalar/mobil/lib/core/storage/offline_sync_service.dart`
- `uygulamalar/mobil/lib/core/network/connectivity_restore_service.dart`
- `uygulamalar/mobil/lib/features/business/data/business_detail_deposu.dart`
...
- `uygulamalar/mobil/tool/release_gate_check.dart`

Calistirma:

```bash
dart run uygulamalar/mobil/tool/release_gate_check.dart <metrics.json>
```

Ornek dry-run:

```bash
dart run uygulamalar/mobil/tool/release_gate_check.dart uygulamalar/mobil/tool/release_gate_metrics_example.json
```
...
- login/kesify/business/menu smoke kiriksa
