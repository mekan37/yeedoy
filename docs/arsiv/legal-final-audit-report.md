...
**Sorun:** `legal-data-inventory.md` satır 7.4, 8.5, 159 ve 176'da hâlâ Sentry listeleniyor. Bu dosya 6 ana belge kapsamında değil ancak aynı `docs/hukuki/` dizininde duruyor ve yanıltıcı.
...
Tüm placeholder'lar `docs/hukuki/legal-placeholder-inventory.md` dosyasında tek tabloda toplanmıştır (2026-06-19).
