...
- `/sunucu/izleme` hata orani veya `invalid_event` orani kabul edilemez seviyeye cikiyorsa
...
1. Hosting saglayicisinda bir onceki saglikli `uygulamalar/web` release artifact'ine revert et.
...
- [ ] `/sunucu/izleme` hata orani normale dondu
