...
- analytics mapping, `/sunucu/izleme` hardening ve `/q/:shortCode` edge redirect zinciri
...
- Analytics zinciri:
  - `/sunucu/izleme` ve `log_event_v1` uyumsuzlugu tekrar olusursa izleme metriklerinde hemen gorulur.
