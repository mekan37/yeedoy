...
- SMS provider sözleşmesi (KVKK/IYS) yok — bkz. `docs/delivery/delivery-integration-status.md` (SMS bölümü)
...
- `docs/delivery/delivery-integration-status.md` — SMS/e-posta/push delivery durumu (SMS 2FA neden tercih edilmedi bağlamı)
