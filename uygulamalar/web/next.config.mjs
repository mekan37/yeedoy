...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Flutter used /owner/qr/design; /owner/qr itself moved to /sahip/karekod
      // (points directly at the final destination, no double-redirect chain)
      { source: '/owner/qr/design', destination: '/sahip/karekod', permanent: true },
