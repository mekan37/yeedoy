...
import type { NavSection } from './panel-sidebar';
...
const adminNavSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/admin/business-submissions', label: 'İşletme Talepleri', icon: <PlusIcon /> },
      { href: '/admin/reports', label: 'Raporlar', icon: <FileTextIcon /> },
      { href: '/admin/suspended', label: 'Askıya Alma', icon: <GiftIcon /> },
      { href: '/admin/users', label: 'Kullanıcılar', icon: <UsersIcon /> },
      { href: '/admin/reviews', label: 'Yorumlar', icon: <StarIcon /> },
      { href: '/admin/verified', label: 'Doğrulanmış İşletmeler', icon: <CheckCircleIcon /> },
      { href: '/admin/appeals', label: 'İtirazlar', icon: <ScaleIcon /> },
      { href: '/admin/receipt-submissions', label: 'Fiş Başvuruları', icon: <ReceiptIcon /> },
  ...
  },
  {
    ...
    items: [
      { href: '/admin/roles', label: 'Roller', icon: <ShieldIcon /> },
      { href: '/admin/observability', label: 'Gözlemlenebilirlik', icon: <ActivityIcon /> },
      { href: '/admin/dev-tools', label: 'Geliştirici Araçları', icon: <TerminalIcon /> },
      { href: '/admin/audit', label: 'Denetim Kaydı', icon: <ClipboardIcon /> },
      { href: '/admin/temp-uploads', label: 'Geçici Yüklemeler', icon: <UploadIcon /> },
    ],
  },
];
...
function ScaleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M3 6l9 6 9-6" />
      <path d="M6 18H3l3-9 3 9z" />
      <path d="M18 18h3l-3-9-3 9z" />
    </svg>
  );
}
