...
const ownerNavSections: NavSection[] = [
  {
    title: 'Operasyon',
    items: [
      { href: '/owner/dashboard', label: 'Genel Bakış', icon: <HomeIcon />, exact: true },
      { href: '/owner/businesses', label: 'İşletmeler', icon: <BuildingIcon /> },
      { href: '/owner/menus', label: 'Menüler', icon: <MenuIcon /> },
      { href: '/owner/onboarding', label: 'Başlangıç Rehberi', icon: <RocketIcon /> },
    ],
  },
  {
    title: 'Büyüme',
