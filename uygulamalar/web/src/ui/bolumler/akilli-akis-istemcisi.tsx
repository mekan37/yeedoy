  ...
  return (
    <div className="rounded-xl border border-border bg-card p-4 flex flex-col gap-2">
      ...
      <a
        ...
        className="text-base font-extrabold text-textStrong hover:text-primary"
      >
        {item.business_name}
      </a>
...
export default function AkilliAkisIstemcisi({ initialItems }: Props) {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 max-w-2xl mx-auto">
      <h1 className="text-xl font-black text-textStrong">Akıllı Akış</h1>
      ...
      {hasMore && (
        <button
          onClick={loadMore}
          disabled={loading}
          className="w-full rounded-xl border border-border bg-card py-3 text-sm font-bold text-textStrong disabled:opacity-50"
        >
