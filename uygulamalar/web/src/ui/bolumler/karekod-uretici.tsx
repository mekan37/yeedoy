...
const brandingCopy = {
  tr: {
    studio: 'Karekod Tasarım Kiti',
    studioBody: 'Bu ekran yalnızca sunum, karekod ve açık bağlantı ayarlarını kaydeder. Menü CRUD panelde kalır.',
    qrTab: 'Karekod ve Bağlantılar',
    brandingTab: 'Şablon ve Marka',
    save: 'Kaydet',
    saving: 'Kaydediliyor...',
    saved: 'Marka ayarları kaydedildi.',
    reset: 'Kayıtlı ayarlara dön',
    resetDone: 'Yerel değişiklikler geri alındı.',
    saveError: 'Kayıt sırasında hata oluştu.',
    uploadError: 'Görsel yükleme başarısız.',
    unsaved: 'Kaydedilmemiş değişiklik var.',
    savedState: 'Kayıtlı varsayılan',
    previewLink: 'Önizleme bağlantısı',
    copyPreview: 'Önizleme bağlantısını kopyala',
    openPreview: 'Önizleme aç',
    uploadLogo: 'Logo yükle',
    uploadCover: 'Kapak yükle',
    uploadBackground: 'Arka plan yükle',
    useExisting: 'Mevcut görseli kullan',
    assets: 'Görsel varlıklar',
    preview: 'Canlı önizleme',
    backgroundMode: 'Arka plan modu',
    headerLayout: 'Başlık yerleşimi',
    cardStyle: 'Kart yoğunluğu',
    fontScale: 'Yazı ölçeği',
    toggles: 'Göster / gizle',
    solid: 'Düz',
    gradient: 'Gradient',
    image: 'Görsel',
    left: 'Sola hizalı',
    ...
    publicLink: 'Açık menü bağlantısı',
    shortLink: 'Kısa bağlantı',
    copyPublic: 'Açık bağlantıyı kopyala',
    copyShort: 'Kısa linki kopyala',
    downloadPng: 'PNG indir',
    downloadSvg: 'SVG indir',
    copyOk: 'Link kopyalandı.',
  ...
  en: {
    ...
    qrTab: 'QR and Links',
    brandingTab: 'Template and Branding',
    save: 'Save',
    saving: 'Saving...',
    saved: 'Brand settings saved.',
    reset: 'Revert to saved defaults',
            ...
            >
              <div className="relative min-h-[220px] overflow-hidden p-5 text-white" style={presentationView.heroStyle}>
                ...
                <div className={`relative z-10 flex h-full flex-col justify-between gap-5 ${presentationView.headerAlignClassName}`}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {presentationView.showFeatured ? <PreviewBadge>{labels.featured}</PreviewBadge> : null}
              ...
              <div className={`grid gap-3 p-4 ${presentationView.isPhotoHeavy ? 'md:grid-cols-2' : ''}`}>
                ...
                <PreviewItem
                  ...
                  blurDataUrl={blurDataUrl}
                  title={draft.defaultLang === 'tr' ? 'İmza tabak' : 'Signature plate'}
                  subtitle={draft.defaultLang === 'tr' ? 'Şablon ve marka önizlemesi' : 'Template and branding preview'}
