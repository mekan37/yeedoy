...
const adminNavSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/yonetici/askiya-alinanlar', label: 'Askıya Alma', icon: <GiftIcon /> },
      { href: '/yonetici/kullanicilar', label: 'Kullanıcılar', icon: <UsersIcon /> },
      { href: '/yonetici/yorumlar', label: 'Yorumlar', icon: <StarIcon /> },
      { href: '/yonetici/itirazlar', label: 'İtirazlar', icon: <ScaleIcon /> },
      { href: '/yonetici/fis-basvurulari', label: 'Fiş Başvuruları', icon: <ReceiptIcon /> },
...
function FlagFeatureIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z" />
      <line x1="4" y1="22" x2="4" y2="15" />
      <circle cx="19" cy="19" r="3" fill="var(--yd-color-primary)" stroke="none" />
    </svg>
  );
}
