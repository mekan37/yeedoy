...
export function HamburgerDugmesi() {
  ...
  return (
    <button
      ...
      className="flex h-11 w-11 items-center justify-center rounded-2xl text-text hover:bg-cardAlt focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-primary/30 md:hidden"
    >
      <svg
        width="20"
        height="20"
