    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="font-[800] text-textStrong text-sm">Oturum {minutes} dakika içinde sona eriyor</p>
          <p className="mt-0.5 text-xs text-muted">Çalışmanızı kaybetmemek için oturumu uzatın.</p>
          <div className="mt-3 flex gap-2">
            <button
              type="button"
              onClick={extend}
              className="inline-flex min-h-9 items-center rounded-xl bg-primary px-3 text-xs font-[800] text-white"
            >
              Oturumu Uzat
            </button>
            <button
              type="button"
              onClick={signOut}
              className="inline-flex min-h-9 items-center rounded-xl border border-border px-3 text-xs font-[700] text-muted hover:text-textStrong"
            >
              Çıkış Yap
            </button>
            <button
