...
export const landingCopy = {
  ...
  workflow: [
    ...
    {
      step: '03',
      title: 'See what guests use',
      body: 'Track scans, opens and feedback. Teams see what menu items get attention and what gets skipped.',
    },
  ],
  detail: {
    kicker: 'Public by design',
    title: 'A menu page that looks like the restaurant, not the software.',
    body: 'Yeedoy keeps the public side focused on discovery, item detail, QR access and brand devir. Admin CRUD stays out of the guest-facing app.',
    points: ['Mobile-first public routes', 'Branded QR studio', 'Analytics that respect privacy', 'Owner panel devir'],
  },
  finalCta: {
    title: 'Put a live menu on every table.',
    body: 'Publish the public menu, then run day-to-day operations from the owner panel.',
