...
export default async function HeroesPage() {
  ...
  try {
    const { data, error } = await supabase.rpc('get_weekly_contributor_leaderboard_v1' as never) as { data: LeaderboardEntry[] | null; error: any };
    ...
    <main className="min-h-screen bg-bg">
      <div className="mx-auto max-w-2xl px-4 py-12">
        <div className="mb-8">
          ...
          <h1 className="font-display text-3xl font-[900] text-textStrong mb-2">Haftalık Kahramanlar</h1>
          <p className="text-muted">Bu haftanın en aktif gurmeleri</p>
        </div>
