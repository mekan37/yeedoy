...
import type { Campaign } from './campaign-form';

export const metadata: Metadata = {
  title: 'Kampanyalar | Owner Panel',
...
export default async function OwnerCampaignsPage() {
  ...
  type ListResult  = { data: { total: number; campaigns: Campaign[] } | null };
  ...
  const campaigns: Campaign[] = listRes.data?.campaigns ?? [];
