...
import { isletmelerCsvOlustur, type IsletmeSatiri } from './isletmeler-yardimcilari';

export function DisaAktarButonu({ rows }: { rows: IsletmeSatiri[] }) {
  function disaAktar() {
    const csv = isletmelerCsvOlustur(rows);
