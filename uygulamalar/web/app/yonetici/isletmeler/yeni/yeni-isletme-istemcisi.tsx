...
export function YeniIsletmeIstemcisi() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      try {
        ...
        const res = await fetch('/sunucu/yonetici/isletmeler', {
          method: 'POST',
  ...
  if (created) {
    return (
      <div className="flex flex-col">
        <PanelSayfaBasligi eyebrow="Yönetici" title={t.step2Label} />
          ...
          <PanelBolumKarti>
            <div className="flex flex-col items-start gap-6">
              ...
              <div className="flex flex-wrap gap-3">
                <Link href={`/yonetici/isletmeler/${created.id}/menuler/yeni`}>
      ...
      <PanelIcerikYuzeyi className="pt-6">
        <form onSubmit={handleSubmit} noValidate>
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            {/* Sağ sütun */}
            <div className="flex flex-col gap-5">
              <PanelBolumKarti title="Konum ve İletişim">
                {/* Şehir + İlçe */}
              ...
              <PanelBolumKarti title="Koordinat (opsiyonel)">
