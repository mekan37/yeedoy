...
import { flagCsvOlustur, type FeatureFlag } from './flag-yardimcilari';

export function DisaAktarButonu({ rows }: { rows: FeatureFlag[] }) {
  function disaAktar() {
    const csv = flagCsvOlustur(rows);
  ...
  return (
    <button
      ...
      title="Bu görünümdeki (filtrelenmiş) flagleri CSV olarak indir"
