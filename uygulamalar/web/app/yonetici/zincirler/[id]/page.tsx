...
export const metadata: Metadata = {
  title: 'Zincir Detayı | Yonetici Paneli',
...
export default async function AdminChainDetailPage({ params }: Props) {
  ...
  return (
    <div className="flex flex-col">
      ...
      />
      <PanelIcerikYuzeyi className="pt-6 space-y-6">
        {/* Chain info */}
        <PanelBolumKarti title="Zincir Bilgileri">
        ...
        {/* Branches */}
        <PanelBolumKarti title="Şubeler" noPadding>
          {branches.length === 0 ? (
            <div className="p-6">
              <PanelEmptyState
                icon={<BuildingIcon />}
        ...
        {/* Template menu note */}
        {chain.template_business_id && (
          <PanelBolumKarti title="Zincir Menüsü">
