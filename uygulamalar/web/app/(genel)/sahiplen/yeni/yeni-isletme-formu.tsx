...
const INPUT_CLS = 'min-h-11 w-full rounded-xl border border-border bg-bg px-3 text-sm font-[700] text-textStrong outline-none focus:ring-2 focus:ring-primary/30';
    ...
    <div className="overflow-hidden rounded-2xl border border-border bg-bg">
      <form action={action} className="space-y-4 p-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-[800] text-muted">İlçe *</label>
            <input name="district" required placeholder="Yenimahalle" className={INPUT_CLS} />
          </div>
        </div>

        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-[800] text-muted">Adres *</label>
          <textarea
            name="address"
            required
            rows={2}
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-[800] text-muted">Web Sitesi</label>
        ...
        <div className="rounded-xl border border-blue-100 bg-blue-50 px-4 py-3 text-xs text-blue-800">
          <p className="font-[800]">Başvuru süreci</p>
