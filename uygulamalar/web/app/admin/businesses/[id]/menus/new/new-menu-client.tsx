...
export function NewMenuClient({ businessId }: { businessId: string }) {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      try {
        ...
        const res = await fetch(`/api/admin/businesses/${businessId}/menus`, {
          method: 'POST',
  ...
  if (created) {
    return (
      <div className="flex flex-col">
        <PanelPageHeader eyebrow="Admin" title={t.newMenuSaved} />
    ...
    <div className="flex flex-col">
      ...
      <PanelContentSurface className="pt-6">
        <form onSubmit={handleSubmit} noValidate className="max-w-xl">
          <PanelSectionCard title="Menü Bilgileri">
            {/* Menü adı */}
            <div className="mb-4">
