  ...
  if (!open) {
    return (
      <button
        ...
        className="inline-flex min-h-[40px] items-center gap-2 rounded-xl px-4 text-sm font-black text-white"
  ...
  return (
    <form onSubmit={submit} className="mb-6 rounded-2xl border border-border bg-card p-5">
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-base font-black text-textStrong">Yeni Liste Oluştur</h2>
      ...
      <div className="flex flex-col gap-3">
        ...
        <button
          ...
          className="min-h-[44px] rounded-xl text-sm font-black text-white disabled:opacity-50"
          style={{ background: 'var(--yd-gradient-primary)' }}
        >
