  ...
  return (
    <div className="mx-auto max-w-[1300px] p-6">
      ...
      <div className="mt-5 flex items-center gap-4 rounded-2xl border border-blue-200 bg-blue-50 px-5 py-4">
        ...
        <Link href="/sahip/settings" className="shrink-0 flex items-center gap-1.5 rounded-xl border border-blue-300 bg-white px-4 py-2 text-[12px] font-[800] text-[#1a1a2e] transition hover:bg-blue-50">
