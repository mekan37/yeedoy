...
import { SahipArama } from './sahip-arama';
...
export default async function SahipAnaSayfa() {
      ...
      <section id="isletme-bul" className="px-6 py-20">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-6 text-center text-sm text-[#6b7280]">
            ...
            <Link href="/sahip/isletmeler/yeni" className="font-[700] text-[#dc2626] hover:underline">
              Yeni işletme ekle →
            </Link>
          </div>
        </div>
