      ...
      <footer className="border-t border-[#f0f0f0] bg-white px-6 py-8">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-6 text-xs text-[#9ca3af]">
            <Link href="/yasal/terms" className="hover:text-[#374151] transition">Kullanım Koşulları</Link>
            <Link href="/yasal/privacy" className="hover:text-[#374151] transition">Gizlilik Politikası</Link>
