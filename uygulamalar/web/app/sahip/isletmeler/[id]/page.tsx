          ...
          <div className="flex flex-col gap-5">
            ...
            <PanelBolumKarti title="Konum">
              <dl className="space-y-2 text-sm">
                ...
                <div>
                  <dt className="text-xs font-bold uppercase tracking-wide text-muted">İlçe</dt>
                  <dd className="mt-0.5 text-textStrong">{business.district ?? '—'}</dd>
                </div>
                {business.lat && business.lng && (
                  <div>
                    <dt className="text-xs font-bold uppercase tracking-wide text-muted">Koordinat</dt>
                ...
                {[
                  ...
                  value ? (
                    <div key={label}>
                      ...
                      <dd className="mt-0.5 truncate text-xs text-(--yd-color-primary)">
