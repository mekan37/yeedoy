...
void main() {
  final kutuphane = [
    const StockDishImage(
      id: '1',
      imageUrl: 'https://x.test/corbalar/mercimek.webp',
      keywords: ['mercimek çorbası'],
    ),
    const StockDishImage(
      id: '2',
      imageUrl: 'https://x.test/sulu_yemekler/ali_nazik.webp',
      keywords: ['ali nazik'],
    ),
    const StockDishImage(
      id: '4',
      imageUrl: 'https://x.test/sulu_yemekler/bamya.webp',
      keywords: ['etli bamya'],
    ),
    const StockDishImage(
      id: '5',
      imageUrl: 'https://x.test/corbalar/bamya.webp',
  ...
  group('VarsayilanYemekSozlugu.bul', () {
    ...
    test(
      'ayni kelime birden fazla goselde geçerse en uzun/ozgul anahtar kazanir',
      () {
        expect(
