...
void main() {
  group('priceLevelSymbol', () {
    ...
    test(
      'returns an approximate amount when cents is positive, even with a priceLevel',
      () {
    ...
    test(
      'returns an approximate amount when cents is positive, regardless of premium priceLevel',
      () {
    ...
    test(
      'falls back to cents-derived approximate amount when priceLevel is null',
      () {
    ...
    test(
      'falls back to cents-derived approximate amount when priceLevel is unrecognised',
      () {
    ...
    test(
      'falls back to priceLevel tier symbol when cents is null or non-positive',
      () {
    ...
    test(
      'returns null when priceLevel is unrecognised and cents is absent',
      () {
