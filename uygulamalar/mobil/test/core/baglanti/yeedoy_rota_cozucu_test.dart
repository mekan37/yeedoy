...
void main() {
  group('resolveYeedoyRouteFromQr', () {
    ...
    test('resolves business route from https web url', () {
      final route = resolveYeedoyRouteFromQr(
        'https://yeedoy.com/b/11111111-1111-4111-8111-111111111111',
      );
      expect(route, '/b/11111111-1111-4111-8111-111111111111');
    });

    test('resolves business menu route from app deep link', () {
      final route = resolveYeedoyRouteFromQr(
        'yeedoy://b/11111111-1111-4111-8111-111111111111/menu/22222222-2222-4222-8222-222222222222',
      );
      expect(
        route,
        '/b/11111111-1111-4111-8111-111111111111/menu/22222222-2222-4222-8222-222222222222',
      );
    });
