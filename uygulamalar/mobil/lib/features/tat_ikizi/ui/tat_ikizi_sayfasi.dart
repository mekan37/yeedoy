...
import '../../gurmeler/domain/gurme_kontrolculeri.dart';
import '../domain/tat_ikizi_kontrolculeri.dart';
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${match.overlapCount} ortak mekan',
            ...
            Wrap(
              ...
              children: [
                if (match.reviewSimilarity != null)
                  _BoyutBadge(
                    etiket: 'Yorum Benzerliği',
                    deger: (match.reviewSimilarity! * 100).round(),
                    renk: AppColors.primary,
                  ),
                if (match.signalSimilarity != null)
                  _BoyutBadge(
                    etiket: 'Tercih Benzerliği',
                    deger: (match.signalSimilarity! * 100).round(),
                    renk: AppColors.info,
                  ),
                _BoyutBadge(
                  etiket: 'Ortak Mekan',
                  deger: match.overlapCount,
...
class _BoyutBadge extends StatelessWidget {
  final String etiket;
  final int deger;
  final Color renk;
  final String birim;
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: Alignment.centerRight,
              child: OutlinedButton(
                onPressed: () => context.go('/isletme/${rec.businessId}'),
                ...
                for (final ex in items) ...[
                  _ReasonRow(
                    ...
                    onTap: ex.businessId.isEmpty
                        ? null
                        : () => context.go('/isletme/${ex.businessId}'),
                  ),
                  const SizedBox(height: 8),
                ],
              ],
