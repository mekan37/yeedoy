...
import '../../../core/depolama/favori_koleksiyon_tercihleri.dart';
import '../data/favoriler_deposu.dart';
import '../data/koleksiyon_sosyal_deposu.dart';
import '../data/koleksiyon_paylasim_deposu.dart';
...
import '../../profil/domain/uretici_profil_saglayicisi.dart';
        ...
        children: [
          ...
          if ((_isSharedMode && _sharedLoading) ||
            ...
            for (final b in filtered) ...[
              RepaintBoundary(
                key: ValueKey('fav_rb_${b.id}'),
                child: _FavoriteBusinessCard(
                  key: ValueKey('fav_${b.id}'),
                  business: b,
                  distanceKm: _pos == null ? null : _distanceKm(b, _pos!),
                  onTap: () => context.go('/isletme/${b.id}'),
