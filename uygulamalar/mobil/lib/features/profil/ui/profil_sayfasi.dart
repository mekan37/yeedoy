...
import '../../../core/arayuz/baglanti_yapistirma_alani.dart';
import '../../../features/shared/ui/basarilar/basari_gorselleri.dart';
import '../../shared/ui/bilesenler/topluluk_puani_aciklama_paneli.dart';
import '../../kimlik/domain/kimlik_saglayicilari.dart';
import '../../fiyat_uyarilari/domain/fiyat_uyari_modelleri.dart';
import '../../fiyat_uyarilari/domain/fiyat_uyari_saglayicilari.dart';
import '../domain/basari.dart';
import '../domain/basari_saglayicilari.dart';
import '../domain/isletme_akisi_saglayicisi.dart';
import '../domain/uretici_profil_saglayicisi.dart';
import '../domain/gunluk_mikro_gorev.dart';
import '../domain/gunluk_mikro_gorev_saglayicisi.dart';
import '../domain/koruma_sinyalleri_saglayicisi.dart';
import '../domain/profil_ilerleme_saglayicisi.dart';
import '../domain/profil_istatistikleri.dart';
import '../domain/profil_istatistikleri_saglayicisi.dart';
import '../domain/itibar_saglayicisi.dart';
import '../domain/kullanici_koruma_sinyalleri.dart';
import 'profil_ayarlar_sayfasi.dart';
import 'bilesenler/basari_gridi.dart';
import 'bilesenler/profil_kimlik_karti.dart';
        ...
        children: [
          ...
          Card(
            child: ListTile(
              ...
              subtitle: const Text('Puan kartları ve ödüller'),
              trailing: const Icon(Icons.chevron_right_rounded),
              onTap: () => context.push('/sadakat-kartlarim'),
            ),
          ),
          const SizedBox(height: 8),
          Card(
            child: ListTile(
              ...
              subtitle: const Text('Check-in geçmişin ve notların'),
              trailing: const Icon(Icons.chevron_right_rounded),
              onTap: () => context.push('/yemek-gunlugum'),
            ),
          ),
          const SizedBox(height: 8),
          Card(
            child: ListTile(
              ...
              subtitle: const Text('Masa siparişi geçmişin'),
              trailing: const Icon(Icons.chevron_right_rounded),
              onTap: () => context.push('/siparislerim'),
            ),
          ),
          const SizedBox(height: 12),
          if (user == null) ...[
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              child: ListTile(
                ...
                onTap: () => context.push('/isletme/${item.event.businessId}'),
              ),
            );
          },
        );
...
class _LoyaltyCardsSection extends ConsumerWidget {
  @override
  Widget build(BuildContext context, WidgetRef ref) {
...
class _LoyaltyCardTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final rewardLabel = card.rewardType == 'discount_pct'
        ? '%${card.rewardValue} indirim'
        : 'Ücretsiz ürün';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.loyalty_rounded, color: AppColors.primary, size: 20),
            ...
            const SizedBox(height: 6),
            Text(
              card.rewardThresholdPts > 0 && remaining > 0
                  ? '$remaining puan daha — $rewardLabel'
