...
const _kPopularSearches = [
  'Döner', 'Pizza', 'Burger', 'Kebap', 'Kahvaltı',
  'Pide', 'Lahmacun', 'Çorba', 'Tatlı', 'Mantı',
];
...
class DiscoverySearchBar extends StatefulWidget {
  const DiscoverySearchBar({
    ...
    this.popularSearches = _kPopularSearches,
    this.hintText,
      ...
      children: [
        ...
        if (_showPopular) ...[
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              for (final query in widget.popularSearches)
                ActionChip(
                  label: Text(query),
                  onPressed: () {
                    widget.controller.text = query;
