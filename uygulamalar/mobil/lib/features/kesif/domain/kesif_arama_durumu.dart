...
class DiscoverySearchState {
  ...
  /// Diyet filtreleri — sadece vegan/vejetaryen/glutensiz menü ürünleri olan
  /// işletmeleri döndür. Search RPC'ye p_vegan_only / p_gluten_free_only olarak geçer.
  final bool veganOnly;
  final bool glutenFreeOnly;

  bool get hasBudgetFilter => maxBudgetCents != null && maxBudgetCents! > 0;
  bool get hasDietFilter => veganOnly || glutenFreeOnly;
