...
final sadakatRepositoryProvider = Provider<SadakatRepository>((ref) {
  final client = ref.watch(supabaseProvider);
  return SadakatRepository(client);
});
...
class SadakatRepository {
  SadakatRepository(this.client);
  final SupabaseClient client;

  Future<List<LoyaltyCard>> getMyLoyaltyCards() async {
  ...
  String? getMyLoyaltyQrData() => client.auth.currentUser?.id;
}
