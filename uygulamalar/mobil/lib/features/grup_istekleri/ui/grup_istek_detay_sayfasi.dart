...
import '../../kesif/data/arama_deposu.dart';
import '../data/grup_istekleri_deposu.dart';
import '../domain/grup_istek_modelleri.dart';
...
class _GroupRequestDetailPageState
  ...
  String get _shareUrl =>
      '${AppConfig.webBaseUrl}/grup-istekleri/${widget.requestId}';
              ...
              SizedBox(
                ...
                child: FilledButton(
                  onPressed: () {
                    ...
                    context.go('/isletme/${offer.businessId}');
                  },
