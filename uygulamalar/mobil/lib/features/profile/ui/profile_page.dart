          ...
          child: Column(
            children: [
              ListTile(
                ...
                subtitle: Text(t.profileMenuAccountSubtitle),
              ...
              ListTile(
                ...
                title: Text(t.profileMenuDietTitle),
                subtitle: Text(t.profileMenuDietSubtitle),
                trailing: const Icon(Icons.chevron_right_rounded),
              ...
              ListTile(
                ...
                title: Text(t.profileMenuLoyaltyTitle),
                subtitle: Text(t.profileMenuLoyaltySubtitle),
                trailing: const Icon(Icons.chevron_right_rounded),
              ...
              ListTile(
                ...
                title: Text(t.profileMenuNotificationsTitle),
                subtitle: Text(t.profileMenuNotificationsSubtitle),
                trailing: const Icon(Icons.chevron_right_rounded),
                onTap: () => context.go('/inbox'),
              ),
              const Divider(height: 1, color: AppColors.border),
              ListTile(
                ...
                title: Text(t.profileMenuHelpTitle),
                subtitle: Text(t.profileMenuHelpSubtitle),
                trailing: const Icon(Icons.chevron_right_rounded),
