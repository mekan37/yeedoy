...
import '../domain/isletme_yorumlari_kontrolcusu.dart';
import '../../shared/ui/yardimci-bilesenler/rapor_paneli.dart';
import '../domain/benim_oylarim_saglayicisi.dart';
          ...
          child: GestureDetector(
            ...
            child: ClipRRect(
              ...
              child: Image.network(
                ...
                height: 80,
                fit: BoxFit.cover,
                semanticLabel: 'Yorum fotoğrafı ${i + 1}',
