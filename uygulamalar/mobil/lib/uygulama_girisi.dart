...
import 'mobil_uygulama/mobil_uygulama.dart';
import 'core/izleme/uygulama_telemetrisi.dart';
import 'core/izleme/hata_siniflandirmasi.dart';
import 'core/performans/performans_esikleri.dart';
import 'core/guvenlik/guvenli_yerel_depolama.dart';
import 'core/guvenlik/guvenli_hata_yazdir.dart';
import 'core/ayarlar/reklam_ayarlari.dart';
...
Future<void> main() async {
  ...
  final startupTasks = <Future<void>>[_ensureFirebaseInitialized()];
  if (AdConfig.isNativeEnabled) {
    startupTasks.add(MobileAds.instance.initialize());
  }
