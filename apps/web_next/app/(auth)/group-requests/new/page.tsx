...
export default function GroupRequestNewPage() {
  ...
  async function submit() {
    ...
    try {
      ...
      if (err) throw err;
      router.push(`/group-requests/${req!.id}`);
    } catch (err: unknown) {
  ...
  return (
    <main className="min-h-screen bg-bg">
      <div className="mx-auto max-w-lg px-4 py-12">
        <Link href="/group-requests" className="mb-6 inline-flex items-center gap-1.5 text-sm text-muted hover:text-primary cursor-pointer">← Geri</Link>
