      ...
      <div className="mx-auto max-w-2xl px-4 pb-20 pt-10">
        ...
        {dietLabels.length > 0 && (
          <div className="mb-6 flex flex-wrap items-center gap-2 rounded-[20px] border border-border bg-cardAlt px-4 py-3 shadow-yd1">
            ...
            <Link href="/onboarding" className="ml-auto text-xs font-[700] text-primary hover:underline">
              Güncelle →
            </Link>
          </div>
        )}
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          {[
            { href: '/taste-twin', label: 'Taste Twin', desc: 'Zevk eşleri' },
            { href: '/price-alerts', label: 'Fiyat Alarmları', desc: 'Takip et' },
          ].map(({ href, label, desc }) => (
