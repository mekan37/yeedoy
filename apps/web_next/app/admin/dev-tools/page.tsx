...
export const metadata: Metadata = {
  title: 'Geliştirici Araçları | Admin Panel',
    ...
    <div className="flex flex-col">
      ...
      <PanelContentSurface className="pt-6">
        <div className="flex flex-col gap-6">
          ...
          <PanelSectionCard title="Kuyruk Sayıları (RPC)">
          ...
          {/* SLA metrics */}
          <PanelSectionCard title="SLA Metrikleri (RPC)">
            <pre className="overflow-auto rounded-lg bg-[color:var(--yd-color-bg)] p-4 text-xs font-mono text-textStrong">
          ...
          {/* Useful links */}
          <PanelSectionCard title="Hızlı Bağlantılar">
