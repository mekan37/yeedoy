...
export const metadata: Metadata = {
  title: 'İnceleme Kuyruğu | Admin Panel',
    ...
    <div className="flex flex-col">
      ...
      <PanelContentSurface className="pt-6">
        <div className="flex flex-col gap-6">
          ...
          {/* Reports */}
          {reports.length > 0 && (
            <PanelSectionCard title={`Açık Raporlar (${reports.length})`} noPadding>
          ...
          {submissions.length > 0 && (
            <PanelSectionCard title={`İşletme Başvuruları (${submissions.length})`} noPadding>
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border text-left">
          ...
          {suggestions.length > 0 && (
            <PanelSectionCard title={`Kullanıcı Önerileri (${suggestions.length})`} noPadding>
