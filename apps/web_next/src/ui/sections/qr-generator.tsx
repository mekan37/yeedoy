...
import { buildMenuHref, buildShortHref } from '@/src/lib/menu-links';
...
import type { DefaultLang, PresentationSettings } from '@/src/lib/templates/runtime';
...
const QrBrandingPanel = dynamic(
  () => import('@/src/ui/sections/qr-branding-panel').then((module) => module.QrBrandingPanel),
  {
    loading: () => (
...
const brandingCopy = {
  tr: {
    studio: 'QR Studio',
    studioBody: 'Bu ekran yalnizca sunum, QR ve public link ayarlarini kaydeder. Menu CRUD panelde kalir.',
    qrTab: 'QR ve Linkler',
    brandingTab: 'Template ve Branding',
    save: 'Kaydet',
    saving: 'Kaydediliyor...',
    saved: 'Branding ayarlari kaydedildi.',
    ...
    copyPreview: 'Preview linkini kopyala',
    openPreview: 'Preview ac',
    ...
    shortLink: 'Kisa link',
    copyPublic: 'Public linki kopyala',
    ...
    remove: 'Kaldir',
    qrTarget: 'QR hedefi',
    useShort: 'Kisa link kullan',
    fallbackPreview: 'Marka sunumu',
  },
  en: {
    studio: 'QR Studio',
    studioBody: 'This screen only saves presentation, QR and public link settings. Menu CRUD remains in the panel.',
    qrTab: 'QR and Links',
    brandingTab: 'Template and Branding',
    save: 'Save',
    saving: 'Saving...',
    saved: 'Branding settings saved.',
    reset: 'Reset to saved defaults',
            ...
            >
              ...
              <div className={`grid gap-3 p-4 ${presentationView.isPhotoHeavy ? 'md:grid-cols-2' : ''}`}>
                ...
                <PreviewItem
                  ...
                  subtitle={draft.defaultLang === 'tr' ? 'Template ve branding onizlemesi' : 'Template and branding preview'}
