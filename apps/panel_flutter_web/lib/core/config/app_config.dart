class AppConfig {
  ...
  static String ownerDashboardWebUrl({String? businessId}) {
    final base = '$webBaseUrl/owner';
    if (businessId == null || businessId.isEmpty) return base;
    return '$base?businessId=$businessId';
  }
