class BusinessMenu {
  ...
  factory BusinessMenu.fromMap(Map<String, dynamic> map) {
    return BusinessMenu(
      ...
      title: _asString(map, ['title', 'name']) ?? 'Menü',
...
class MenuSection {
  ...
  factory MenuSection.fromMap(Map<String, dynamic> map) {
    return MenuSection(
      id: _asString(map, ['id', 'section_id']) ?? '',
      title: _asString(map, ['title', 'name']) ?? 'Bölüm',
...
class MenuItem {
  ...
  factory MenuItem.fromMap(Map<String, dynamic> map) {
    return MenuItem(
      ...
      sectionId: _asString(map, ['section_id', 'menu_section_id']),
      description: _asString(map, ['description', 'desc', 'details']),
      price: _asDouble(map, ['price', 'unit_price', 'amount']),
