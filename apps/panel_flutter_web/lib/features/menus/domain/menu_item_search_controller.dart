...
final menuItemSearchProvider =
    NotifierProvider<MenuItemSearchController, MenuItemSearchState>(MenuItemSearchController.new);
...
class MenuItemSearchController extends Notifier<MenuItemSearchState> {
  ...
  Future<void> loadMore() async {
    ...
    try {
      ...
      final list = await _fetchPage(offset: state.items.length, limit: pageSize);
