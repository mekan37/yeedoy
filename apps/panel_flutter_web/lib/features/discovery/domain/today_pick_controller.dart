...
final todayPickProvider =
    NotifierProvider<TodayPickController, TodayPickState>(TodayPickController.new);
...
class TodayPickController extends Notifier<TodayPickState> {
  ...
  Future<void> pickOne({bool force = false}) async {
    ...
    try {
      ...
      final item = await ref.read(menuItemSearchRepositoryProvider).pickOneMenuItem(
