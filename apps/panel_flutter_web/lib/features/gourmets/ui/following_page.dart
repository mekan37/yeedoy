  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () => ref.read(gourmetFollowingProvider.notifier).loadInitial(),
        child: ListView(
          ...
          children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    OutlinedButton(
                      onPressed: () => ref.read(gourmetFollowingProvider.notifier).loadInitial(),
            ...
            if (st.loading && st.items.isEmpty)
              ...
              const _EmptyState(message: 'Henüz kimseyi takip etmiyorsun.')
            else ...[
              for (final g in st.items) ...[
                _GourmetTile(
                  ...
                  onUnfollow: () async {
                    ...
                    try {
                      await ref.read(gourmetFollowingProvider.notifier).toggleFollow(g);
                    } catch (e) {
                      if (context.mounted) {
