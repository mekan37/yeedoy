...
class _GourmetsPageState extends ConsumerState<GourmetsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
      appBar: AppBar(title: const Text('Lezzet uzmanlarını keşfet')),
        ...
        child: ListView(
          ...
          children: [
            ...
            if (st.loading && st.items.isEmpty)
              ...
              const _EmptyState(message: 'Henüz lezzet uzmanı yok.')
            else ...[
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            OutlinedButton(
              onPressed: onFollow,
              child: Text(user.isFollowing ? 'Takiptesin' : 'Takip et'),
            ),
          ],
        ),
      ),
