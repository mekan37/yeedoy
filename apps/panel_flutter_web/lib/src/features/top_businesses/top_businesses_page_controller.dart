...
import '../../data/repositories/top_businesses_repository.dart';
import '../../domain/models/top_business.dart';

final topBusinessesListProvider =
    AsyncNotifierProvider.family<TopBusinessesListController, List<TopBusiness>, String>(
