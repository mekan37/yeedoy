-- Bug: upsert_team_member_v1'in yeni-koltuk kontrolu sadece _check_plan_limit_v1'in
-- P0003 (plan_limit_exceeded) firlatmasini yakaliyordu. Ancak _check_plan_limit_v1,
-- caginin owner_claims'te approved satiri olmayan cagiranlar icin P0002 (unauthorized)
-- da firlatabiliyor. upsert_team_member_v1'in kendi disaridaki yetki kontrolu
-- has_business_permission_v1(..., 'team_manage') sadece owner degil manager rolunu de
-- kabul ediyor — yani owner_claims satiri olmayan bir manager yeni uye davet ederse
-- P0002 yakalanmadan disari sizip bu fonksiyonun her yerde koruduğu jsonb {ok,code}
-- sozlesmesini bozuyordu (ham Postgres hatasi olarak). P0002 de yakalanip ayni
-- sozlesmeye cevriliyor.
